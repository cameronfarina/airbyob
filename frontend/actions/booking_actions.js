...
export const fetchAllBookings = () => dispatch => (
  APIBookingsUtil.fetchAllBookings()
    .then(
...
export const fetchBooking = bookingId => dispatch => (
  APIBookingsUtil.fetchBooking(bookingId)
    .then(
...
export const createBooking = booking => dispatch => (
  APIBookingsUtil.createBooking(booking)
    .then(
      booking => dispatch(receiveBooking(booking)),
      errors => dispatch(receiveErrors(errors))
    )
...
export const updateBooking = booking => dispatch => (
  APIBookingsUtil.updateBooking(booking)
    .then(
      booking => dispatch(receiveBooking(booking)),
      errors => dispatch(receiveErrors(errors))
    )
...
export const deleteBooking= bookingId => dispatch => (
  APIBookingsUtil.deleteBooking(bookingId)
    .then(
